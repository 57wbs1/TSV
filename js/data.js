...
const CALENDAR_SEED = [
  ...
  // ═══════ DAY 1 — 26 Apr Sunday ═══════
  // NOTE: events up to & including the flight are in SG TIME (pre-flight at
  // Changi). From Arrival/Lunch onwards, times are BKK local (post-landing).
  { id:'d1_01', day:1, startTime:'06:00', endTime:'07:30', title:'Check-In', location:'Changi Airport Terminal 2',
    category:'admin', attire:'Smart Casual (Long Pants, Collared Top, Covered Shoes)', synicReport: true,
    oics:{ops:'Syn Level Check-in, Syn ICs to update progress'},
    remarks:'(SG TIME) Booking Reference No disseminated 2-3 days prior for online check-in.' },
  { id:'d1_02', day:1, startTime:'07:30', endTime:'08:00', title:'Group Photo in Transit Area', location:'Dreamscape Indoor Garden, Changi T2',
    category:'event', remarks:'(SG TIME) All check-in to be completed.' },
  { id:'d1_03', day:1, startTime:'08:30', endTime:'09:15', title:'Commence Boarding', location:'Gate @ Changi T2',
    category:'admin', synicReport: true, remarks:'(SG TIME) Syn ICs to update when everyone is at the Gate.' },
  { id:'d1_04', day:1, startTime:'09:15', endTime:'11:00', title:'Flight SQ 708 to BKK', location:'SIN → BKK',
    category:'flight', remarks:'Depart 09:15 SG · Arrive 11:00 BKK. Breakfast provided by airline.' },
  { id:'d1_05', day:1, startTime:'11:00', endTime:'13:00', title:'Arrival · Immigration · Movement to Lunch', location:'Suvarnabhumi Airport → Lunch Venue',
    category:'event',
    oics:{ops:'Link-up with Thai Tour Agency POC & Buses'},
    remarks:'(BKK TIME from here on) All times from this event are Bangkok local.' },
  { id:'d1_06', day:1, startTime:'13:00', endTime:'14:30', title:'Lunch', location:'TBC (Catered)',
    category:'meal', remarks:'Lunch Venue TBC (Catered).' },
  { id:'d1_07', day:1, startTime:'14:30', endTime:'17:30', title:'Long Tail Boat Tour @ Chao Phraya River', location:'Chao Phraya River',
    category:'event', attire:'Smart Casual',
    oics:{safety:'Check for lifejackets on boats (Syn 4E, 27E Infra)'},
    visitId:'boat_tour', remarks:'3-hour boat tour. Status: Confirmed. Alternative: Grand Palace.' },
  { id:'d1_08', day:1, startTime:'17:30', endTime:'18:30', title:'Movement to Hotel', location:'Chao Phraya River → Pullman Bangkok Hotel G',
    category:'movement' },
  { id:'d1_09', day:1, startTime:'18:30', endTime:'18:45', title:'Hotel Check-in', location:'Pullman Bangkok Hotel G',
    category:'admin',
    oics:{tour:'Distribute Room Keys', log:'Distribute Room Keys'},
    remarks:'Submit Rooming List to Syn ICs.' },
  { id:'d1_10', day:1, startTime:'18:45', endTime:'19:15', title:'Syn Reflections', location:'Pullman Bangkok Hotel G',
    category:'reflection', synicReport: true,
    remarks:'Follow template provided by learning IC.' },
  { id:'d1_11', day:1, startTime:'19:15', endTime:'02:00', title:'Executive Time · TSV Learning Huddle', location:'Pullman Bangkok Hotel G',
    category:'free',
    oics:{ops:'Syn ICs report movement in/out of hotel', learn:'TSV Learning Huddle (HoD, TSV & Syn Learning ICs)', sa:'TSV Comm Hotwash (PDS, TSV Comm & Syn ICs)'},
